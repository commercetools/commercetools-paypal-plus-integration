...
public class APIContextFactoryTest {
    ...
    public void createApiContext_isNotCached() throws Exception {
        APIContextFactory apiContextFactory = new APIContextFactory("a", "b", SANDBOX);
        APIContext apiContext1 = apiContextFactory.createAPIContext();
        ...
        APIContext apiContext2 = apiContextFactory.createAPIContext();
    ...
    public void typeHasProperEqualsAndHashMethodsImplementation() throws Exception {
        APIContextFactory apiContextFactory1 = new APIContextFactory("aaaa", "bbbb", SANDBOX);
        APIContextFactory apiContextFactory_same = new APIContextFactory("aaaa", "bbbb", SANDBOX);
        APIContextFactory apiContextFactory_differentId = new APIContextFactory("ccc", "bbbb", SANDBOX);
        APIContextFactory apiContextFactory_differentSecret = new APIContextFactory("aaaa", "fff", SANDBOX);
        APIContextFactory apiContextFactory_differentMode = new APIContextFactory("aaaa", "bbbb", "testMode");
